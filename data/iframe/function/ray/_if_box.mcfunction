...
# x轴范围
scoreboard players operation sstemp_min int = x_min int
scoreboard players operation sstemp_max int = x_max int
...
# y轴范围
scoreboard players operation sstemp0 int = y_min int
scoreboard players operation sstemp1 int = y_max int
...
# z轴范围
scoreboard players operation sstemp2 int = z_min int
scoreboard players operation sstemp3 int = z_max int
