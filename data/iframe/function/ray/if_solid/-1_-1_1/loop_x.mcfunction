#iframe:ray/if_solid/-1_-1_1/loop_x
...
execute if score sstemp_lx int < sstemp_ly int if score sstemp_lx int < sstemp_lz int positioned ~-1 ~ ~ run return run function iframe:ray/if_solid/-1_-1_1/loop_x
execute if score sstemp_ly int < sstemp_lz int positioned ~ ~-1 ~ run return run function iframe:ray/if_solid/-1_-1_1/loop_y
